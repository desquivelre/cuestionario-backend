...
/* Tabla Cuestionario */
INSERT INTO cuestionario (ccuestionario, ncuestionario) VALUES ('1', 'Cuestionario NIST CSF - C2M2 Maturity Model');

/* Tabla RespuestaMIL */
INSERT INTO respuestamil (crespuestamil, nrespuestamil) VALUES ('1', 'MIL 0');
INSERT INTO respuestamil (crespuestamil, nrespuestamil) VALUES ('2', 'MIL 1');
INSERT INTO respuestamil (crespuestamil, nrespuestamil) VALUES ('3', 'MIL 2');
INSERT INTO respuestamil (crespuestamil, nrespuestamil) VALUES ('4', 'MIL 3');
...
/* Tabla Pregunta */
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('1', '2', 'ACM-1a', 'Los activos de TI y OT que son importantes para la entrega de la función se inventarian, al menos de manera ad hoc');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('2', '2', 'ACM-1c', 'Los activos de TI y OT inventariados se priorizan en función de criterios definidos que incluyen la importancia para la entrega de la función');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('3', '2', 'ACM-1e', 'El inventario de TI y OT incluye atributos que respaldan las actividades de ciberseguridad (por ejemplo, ubicación, prioridad de activos, propietario de activos, sistema operativo y versiones de firmware)');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('4', '2', 'ACM-1f', 'El inventario de activos de TI y OT está completo (el inventario incluye todos los activos dentro de la función)');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('5', '38', 'WM-1a', 'La investigación de antecedentes del personal (por ejemplo, verificaciones de antecedentes, pruebas de drogas) se realiza en el momento de la contratación, al menos de manera ad hoc');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('6', '38', 'WM-1b', 'Los procedimientos de separación del personal abordan la ciberseguridad, al menos de manera ad hoc');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('7', '38', 'WM-1c', 'La investigación de antecedentes del personal se realiza en el momento de la contratación y periódicamente para los puestos que tienen acceso a los activos que son importantes para el desempeño de la función');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('8', '38', 'WM-1d', 'Los procedimientos de transferencia y separación del personal abordan la seguridad cibernética, incluida la investigación de antecedentes complementaria, según corresponda');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('9', '38', 'WM-1e', 'Se informa al personal de sus responsabilidades para la protección y el uso aceptable de los activos de TI, OT e información');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('10', '38', 'WM-1f', 'La investigación se realiza para todos los puestos (incluidos empleados, proveedores y contratistas) a un nivel acorde con el riesgo del puesto');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('11', '38', 'WM-1g', 'Se implementa un proceso formal de rendición de cuentas que incluye acciones disciplinarias para el personal que no cumple con las políticas y procedimientos de seguridad establecidos');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('12', '50', 'ACM-2a', 'Los activos de información que son importantes para la entrega de la función (por ejemplo, puntos de ajuste SCADA e información del cliente) se inventarian, al menos de manera ad hoc');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('13', '50', 'ACM-2b', 'El inventario de activos de información incluye activos de información dentro de la función que pueden aprovecharse para lograr un objetivo de amenaza');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('14', '50', 'ACM-2c', 'Los activos de información inventariados se clasifican en función de criterios definidos que incluyen la importancia para la entrega de la función');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('15', '50', 'ACM-2d', 'Los criterios de categorización incluyen la consideración del grado en que un activo dentro de la función puede aprovecharse para lograr un objetivo de amenaza');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('16', '50', 'ACM-2e', 'El inventario de activos de información incluye atributos que respaldan las actividades de seguridad cibernética (por ejemplo, categoría de activos, ubicaciones y frecuencias de respaldo, ubicaciones de almacenamiento, propietario de activos, requisitos de seguridad cibernética)');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('17', '67', 'CPM-3a', 'Se establecen, siguen y mantienen procedimientos documentados para las actividades en el dominio del PROGRAMA');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('18', '67', 'CPM-3b', 'Se proporcionan los recursos adecuados (personas, financiación y herramientas) para apoyar las actividades en el ámbito del PROGRAMA');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('19', '67', 'CPM-3c', 'Las políticas actualizadas u otras directivas organizacionales definen los requisitos para las actividades en el dominio del PROGRAMA');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('20', '67', 'CPM-3d', 'La responsabilidad, la rendición de cuentas y la autoridad para el desempeño de las actividades en el dominio del PROGRAMA se asignan al personal');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('21', '69', 'SA-2a', 'Se realizan revisiones periódicas de los datos de registro u otras actividades de monitoreo de ciberseguridad, al menos de manera ad hoc');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('22', '73', 'IR-2a', 'Se establecen criterios para la declaración de incidentes de ciberseguridad, al menos de forma ad hoc');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('23', '73', 'IR-2d', 'Los eventos de ciberseguridad se declaran como incidentes en base a criterios establecidos');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('24', '73', 'TVM-1d', 'Las vulnerabilidades de ciberseguridad que son relevantes para la entrega de la función se mitigan, al menos de manera ad hoc');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('25', '73', 'SA-2d', 'Los indicadores de actividad anómala se establecen y mantienen en función de los registros del sistema, los flujos de datos, las líneas de base de la red, los eventos de ciberseguridad y la arquitectura, y se monitorean en los entornos de TI y OT');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('26', '73', 'IR-2g', 'Las partes interesadas internas y externas (por ejemplo, ejecutivos, abogados, agencias gubernamentales, organizaciones conectadas, proveedores, organizaciones del sector, reguladores) se identifican y notifican sobre incidentes en función de los requisitos de informes de conciencia situacional (SITUACIÓN-3d)');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('27', '73', 'RM-2j', 'La información de gestión de amenazas de las actividades del dominio AMENAZA se utiliza para actualizar los riesgos cibernéticos e identificar nuevos riesgos');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('28', '74', 'SA-2a', 'Se realizan revisiones periódicas de los datos de registro u otras actividades de monitoreo de ciberseguridad, al menos de manera ad hoc');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('29', '74', 'SA-2b', 'Los datos y las alertas de los activos de infraestructura de monitoreo de red y host se revisan periódicamente, al menos de manera ad hoc');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('30', '74', 'SA-2e', 'Las alarmas y alertas se configuran y mantienen para respaldar la identificación de eventos de ciberseguridad');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('31', '74', 'SA-2f', 'Las actividades de monitoreo están alineadas con el perfil de amenazas (AMENAZA-2e)');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('32', '74', 'TVM-1d', 'Las vulnerabilidades de ciberseguridad que son relevantes para la entrega de la función se mitigan, al menos de manera ad hoc');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('33', '74', 'SA-2g', 'Se realiza un seguimiento más riguroso para los activos de mayor prioridad');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('34', '74', 'SA-2i', 'Los indicadores de actividad anómala se evalúan y actualizan periódicamente y de acuerdo con desencadenantes definidos, como cambios en el sistema y eventos externos');
INSERT INTO pregunta (cpregunta, csubcategoria, siglapregunta, npregunta) VALUES ('35', '91', 'IR-3a', 'Los eventos de ciberseguridad detectados se informan a una persona o función específica y se documentan, al menos de manera ad hoc');
...
INSERT INTO detallecuestionario (id, ccuestionario, cpregunta, cusuario, crespuestamil) VALUES ('1', '1', '1', '1','3');
INSERT INTO detallecuestionario (id, ccuestionario, cpregunta, cusuario, crespuestamil) VALUES ('2', '1', '2', '1','2');